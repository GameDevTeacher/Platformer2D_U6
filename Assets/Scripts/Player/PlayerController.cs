...
public class PlayerController : MonoBehaviour
{
    ...
    private void Attack()
    {
        if (!Physics2D.OverlapCircle(groundCheck.position, 0.1f, LayerMask.GetMask("Enemy"))) return;

        var enemyColliders = Physics2D.OverlapCircleAll(groundCheck.position, 0.1f, LayerMask.GetMask("Enemy"));
